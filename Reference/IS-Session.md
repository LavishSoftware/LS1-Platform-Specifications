...
### Syntax
* `mkdir` <[string](#Type:%20string) `path`>
...
* `Bind` "-delete" <[string](#Type:%20string) `name`>
* `Bind` ["-press"|"-release"] <[string](#Type:%20string) `name`> <[string](#Type:%20string) `keyCombo`> <[string](#Type:%20string) `command`>
...
* `Console` <[string](#Type:%20string) `LGUIelementFQN`>
* `Console` <[string](#Type:%20string) `sessionOrUplinkName`>
...
### Syntax
* `Press` "-keylist"
* `Press` ["-hold"|"-release"|"-nomodifiers"] <[string](#Type:%20string) `keyCombination`> <[uint](#Type:%20uint) `milliseconds`>

## Command: Type
- Restricted: Yes

### Syntax
* `Type` <[string](#Type:%20string) `text`>
...
### Syntax
* `MouseTo` ["-relative"] <[string](#Type:%20string) `XandY`>
...
### Syntax
* `MouseWheel` <[int](#Type:%20int) `offset`>
...
### Syntax
* `HUDGroup` <[string](#Type:%20string) `-list`>
* `HUDGroup` "-hide"|"-show"|"-toggle" <[string](#Type:%20string) `name`>
...
### Syntax
* `HUD` "-list"
* `HUD` "-remove" <[string](#Type:%20string) `name`>
* `HUD` "-add" <[string](#Type:%20string) `name`> <[string](#Type:%20string) `XandY`> <[string](#Type:%20string) `text`>

## Command: HUDSet
- Restricted: Yes

### Syntax
* `HUDSet` <[string](#Type:%20string) `name`> ["-s"] ["-c"] ["-l"] ["-t"]
...
* `DotNet` "-list"
* `DotNet` "-unload" <[string](#Type:%20string) `appDomain`>
* `DotNet` <[string](#Type:%20string) `appDomain`> <[string](#Type:%20string) `assemblyName`> <... [string](#Type:%20string) `appParameters`>
...
### Syntax
* `DotScript` "-list"
* `DotScript` "-unload" <[string](#Type:%20string) `appDomain`>
* `DotScript` <[string](#Type:%20string) `xmlFilename`> <... [string](#Type:%20string) `appParameters`>
...
### Members
- [string](#Type:%20string) `Version`: Returns the Inner Space version number
- [string](#Type:%20string) `ISXDK`: Returns the ISXDK version
  - Restricted: Yes
- [int](#Type:%20int) `Build`: Returns the Inner Space build number
- ??? `Stealth[`???`]`
  - Restricted: Yes
- [string](#Type:%20string) `Uplink`: Returns the Name of the current Uplink
- ??? `RemoteControlSenders[`???`]`
  - Restricted: Yes
- [settingsetref](#Type:%20settingsetref) `Configuration`: The main Inner Space settings (InnerSpace.XML)
  - Restricted: Yes
- [settingsetref](#Type:%20settingsetref) `GameConfiguration`: The Inner Space Game Configuration settings (GameConfiguration.XML)
- [settingsetref](#Type:%20settingsetref) `InputConfiguration`: The Inner Space Input Devices configuration settings (InputDevices.XML)
- [agent](#Type:%20agent) `Agent[` `#` `]`: Retrieves an [[ISKernel:Agent|Agent]], by ID
- [jsonarray](#Type:%20jsonarray) `Agents`: Retrieves an array of JSON objects briefly describing all currently defined Agents
...
- [rgb](#Type:%20rgb) `GetPixel[` `x` `,` `y` `]`: Retrieves color information of a specific pixel. Coordinates are relative to the viewable portion of the window, not the games actual display mode
  - Restricted: Yes
- [string](#Type:%20string) `PixelSearch`: See [[Inner_Space:Pixel_Search]] for more information.
  - Restricted: Yes
...
- [bool](#Type:%20bool) `BackgroundCursor`: TRUE if Inner Space is rendering the cursor (while the game is inactive)
  - Restricted: Yes
...
### Members
- [bool](#Type:%20bool) `Open`: TRUE if the console is currently visible
- [bool](#Type:%20bool) `Echo`: TRUE if console "echo" is enabled (i.e. not squelched, and echo off has not been used)
...
### Members
- [string](#Type:%20string) `Filename`: The extensions filename
...
### Members
- [navworld](#Type:%20navworld) `World[` `name` `]`: Retrieves the navigation world with this name
...
### Members
- ??? `ID[`???`]`
- [float](#Type:%20float) `X`: X coordinate
- [float](#Type:%20float) `Y`: Y coordinate
- [float](#Type:%20float) `Z`: Z coordinate
- [string](#Type:%20string) `Name`: Name of the navigational point
- [bool](#Type:%20bool) `ConnectsTo[` `name` `]`: TRUE if the point connects to a specified point
- [bool](#Type:%20bool) `ConnectsFrom[` `name` `]`: TRUE if the point connects from a specified point
- [int](#Type:%20int) `Outgoing`: Number of outgoing connections from this point
- [navpoint](#Type:%20navpoint) `Outgoing[` `n` `]`: nth point with a connection from this point
- [int](#Type:%20int) `Incoming`: Number of incoming connections to this point
- [navpoint](#Type:%20navpoint) `Incoming[` `n` `]`: nth point with a connection to this point
- [string](#Type:%20string) `Custom[` `name` `]`: value of the custom setting &lt;name>
- [string](#Type:%20string) `Note`: A user-defined note set with the navigational point
...
### Members
- ??? `Name[`???`]`
- [navpoint](#Type:%20navpoint) `Point[` `name` `]`: Retrieves the point with the given name
- [int](#Type:%20int) `Points`: Total number of points in this world
- [int](#Type:%20int) `LastID`: The highest point ID number in this world
- [navpoint](#Type:%20navpoint) `NearestPoint[` `x` `]`: For use in a single coordinate plane system, retrieves the nearest point to (x,0,0)
- [navpoint](#Type:%20navpoint) `NearestPoint[` `x` `,` `y` `]`: Retrieves the nearest point to (x,y,0)
- [navpoint](#Type:%20navpoint) `NearestPoint[` `x` `,` `y` `,` `z` `]`: Retrieves the nearest point to (x,y,z)
...
### Members
- [int](#Type:%20int) `Points`: The total number of points on this path
- [point3f](#Type:%20point3f) `Point[` `#` `]`: Retrieves a point on the path. (Valid # is 1-Points)
- [string](#Type:%20string) `PointName[` `#` `]`: Retrieves the original name of a point on the path. (Valid # is 1-Points)
- [int](#Type:%20int) `NearestPoint[` `x` `]`: Retrieves the number of the nearest point on the path to location (x,0,0)
- [int](#Type:%20int) `NearestPoint[` `x` `,` `y` `]`: Retrieves the number of the nearest point on the path to location (x,y,0)
- [int](#Type:%20int) `NearestPoint[` `x` `,` `y` `,` `z` `]`: Retrieves the number of the nearest point on the path to location (x,y,z)

### Methods
- `Clear`: Resets the path so it contains no points
- `Reverse`: Reverses the path
- `GetPath[` `world` `,` [point](#Type:%20point) `a` `,` [point](#Type:%20point) `b` `]`: Gets the shortest path from point A to point B (clearing is not required, it is done automatically)
- `GetPath[` `world` `,` [point](#Type:%20point) `a` `,` [point](#Type:%20point) `b` `,` [additional](#Type:%20additional) `points ...` `]`: Gets the shortest path from point A to point B to point C to point D ad infinitum (clearing is not required, it is done automatically)
...
## Event: On Window Position

## Event: OnWindowStateChanging

## Event: OnInternalActivate

## Event: OnRelayReceived
...
## Event: OnVideoSourceAdded

## Event: OnVideoSourceUpdated

## Event: OnVideoSourceRemoved

## Event: OnVideoOutputAdded

## Event: OnVideoOutputUpdated

## Event: OnVideoOutputRemoved

## Event: OnVFSRulesApplied
...
---
# Commands
## Command: WindowPosition
### Syntax
* `WindowPosition`
* `WindowPosition` ["-stealth"] ["-viewable"] <[string](#Type:%20string) `XandY`>

## Command: WindowSize
### Syntax
* `WindowSize`
* `WindowSize` ["-rescale"] "-fullscreen"
* `WindowSize` ["-rescale"] "-reset"
...
### Syntax
* `WindowScale`
* `WindowScale` ["-rescale"] <[float](#Type:%20float) `newPercent`>

## Command: Uplink
### Syntax
* `Uplink` <... [string](#Type:%20string) `fullCommand`>

## Command: LockForeground
- Restricted: Yes

### Syntax
* `LockForeground` "on"|"off"

## Command: WindowCharacteristics
### Syntax
* `WindowCharacteristics` ["-stealth"] <... `options` [["-lock"|"-unlock"]|["-restore"]|["-flash"|"-stopflash"]|["-size" ["-viewable"] "fullscreen"]|["-size" ["-viewable"] <[string](#Type:%20string) `widthAndHeight`>]|["-pos" ["-viewable"] <[string](#Type:%20string) `XandY`>]|["-visibility" ["-noactivate"] "foreground"|"alwaysontop"|"down"|"behind"|"bottom"|"minimize"|"restore"]|["-visibility" ["-noactivate"] "behindwindow" <[string](#Type:%20string) `hexHWND`>]|["-frame" "none"|"thick"|"thin"]]>

## Command: WindowFrame
### Syntax
* `WindowFrame` ["-stealth"] "none"|"thin"|"thick"

## Command: WindowText
### Syntax
* `WindowText` <... [string](#Type:%20string) `newValue`>

## Command: WindowVisibility
### Syntax
* `WindowVisibility` ["-noactivate"] "foreground"|"alwaysontop"|"down"|"behind"|"bottom"|"minimize"|"restore"

## Command: WindowTaskbar
### Syntax
* `WindowTaskbar` "off"
* `WindowTaskbar` "on" <... [string](#Type:%20string) `tooltip`>
...
### Syntax
* `Input`
* `Input` <[uint](#Type:%20uint) `numMouse`>
* `Input` <[string](#Type:%20string) `nameMouse`>

## Command: ClipMouse
### Syntax
* `ClipMouse` ["-lock"] "allow"|"off"|"on"|"toggle"

## Command: FileRedirect
### Syntax
* `FileRedirect` "-list"
* `FileRedirect` "-remove" <[string](#Type:%20string) `originalFilename`>
* `FileRedirect` <[string](#Type:%20string) `originalFilename`> [[string](#Type:%20string) `newFilename`]
...
### Syntax
* `VideoMode` "-list"
* `VideoMode` "-add" <[string](#Type:%20string) `widthAndHeight`>
* `VideoMode` "-emulate" <[string](#Type:%20string) `widthAndHeight`>
...
## TLO: ISSession
Restricted: Yes
- [innerspacesession](#Type:%20innerspacesession) `ISSession`
...
## TLO: LogReader
- [logreader](#Type:%20logreader) `LogReader`
...
- [bool](#Type:%20bool) `AllowFlashWindow`
- [string](#Type:%20string) `PreStartupCommand`
- [string](#Type:%20string) `StartupCommand`
- [bool](#Type:%20bool) `Is2DMode`
- [jsonobject](#Type:%20jsonobject) `ProcessOptions`
- [jsonobject](#Type:%20jsonobject) `ProcessOptionsRepo`

### Methods
- `SetFlashWindow[` [bool](#Type:%20bool) `newValue` `]`
- `SetPrestartupCommand[` [string](#Type:%20string) `newValue` `]`
- `SetStartupCommand[` [string](#Type:%20string) `newValue` `]`
...
### Members
- [videofeedsource](#Type:%20videofeedsource) `Source[` [string](#Type:%20string) `name` `]`
- [videofeedoutput](#Type:%20videofeedoutput) `Output[` [string](#Type:%20string) `name` `]`
- [bool](#Type:%20bool) `PermanentVideoFeeds`

### Methods
- `GetSourceIterator[` [weakref](#Type:%20weakref) `iteratorObj` `]`
- `GetOutputIterator[` [weakref](#Type:%20weakref) `iteratorObj` `]`
- `RegisterSource[` [string](#Type:%20string) `name` `,` [string](#Type:%20string) `sessionName` `,` [string](#Type:%20string) `hexHwnd` `]`
- `RegisterSource[` [string](#Type:%20string) `name` `,` [string](#Type:%20string) `sessionName` `,` [string](#Type:%20string) `hexHwnd` `,` [int](#Type:%20int) `left` `,` [int](#Type:%20int) `top` `,` [int](#Type:%20int) `right` `,` [int](#Type:%20int) `bottom` `]`
- `RegisterOutput[` [string](#Type:%20string) `name` `,` [int](#Type:%20int) `left` `,` [int](#Type:%20int) `top` `,` [int](#Type:%20int) `right` `,` [int](#Type:%20int) `bottom` `,` [byte](#Type:%20byte) `alpha` `,` [string](#Type:%20string) `hexRGBBorderColor` `,` [bool](#Type:%20bool) `permanent` `]`
- `SetPermanentVideoFeeds[` [bool](#Type:%20bool) `newValue` `]`
- `UnregisterSource[` [string](#Type:%20string) `name` `]`
- `UnregisterOutput[` [string](#Type:%20string) `name` `]`
...
- [int](#Type:%20int) `X2`
- [int](#Type:%20int) `Y2`
- [int](#Type:%20int) `Width`
- [int](#Type:%20int) `Height`
- [bool](#Type:%20bool) `ClientAreaOnly`
- [gdiwindow](#Type:%20gdiwindow) `Window`
- [string](#Type:%20string) `Session`
...
- [int](#Type:%20int) `Width`
- [int](#Type:%20int) `Height`
- [int](#Type:%20int) `Alpha`
- [bool](#Type:%20bool) `Border`
- [int](#Type:%20int) `BorderColor`
- [bool](#Type:%20bool) `IsRendering`

### Methods
- `SetRect[` [int](#Type:%20int) `left` `,` [int](#Type:%20int) `top` `,` [int](#Type:%20int) `right` `,` [int](#Type:%20int) `bottom` `]`
- `SetAlpha[` [byte](#Type:%20byte) `newValue` `]`
- `SetBorder[` [bool](#Type:%20bool) `expression` `]`
- `SetBorderColor[` [string](#Type:%20string) `hexRGB` `]`
- `Remove`
...
none.
### Methods
- `RegisterLog[` [string](#Type:%20string) `filenameFilter` `,` [string](#Type:%20string) `eventname` `]`
- `UnregisterLog[` [string](#Type:%20string) `filenameFilter` `,` [string](#Type:%20string) `eventname` `]`
