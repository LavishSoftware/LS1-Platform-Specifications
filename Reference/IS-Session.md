...
### Syntax
* `Input`
* `Input` <[uint](#type-uint) `numMouse`>
* `Input` <[string](#type-string) `nameMouse`>
...
## TLO: ISSession
- Restricted: Yes
- [innerspacesession](#type-innerspacesession) `ISSession`
...
### Members
- [string](#type-string) `Name`
- [bool](#type-bool) `AllowFlashWindow`
- [string](#type-string) `PreStartupCommand`
- [string](#type-string) `StartupCommand`
