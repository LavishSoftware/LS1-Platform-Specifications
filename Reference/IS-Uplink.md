...
### Syntax
* `RemoteUplink` "-list"
* `RemoteUplink` "-connect" <[string](#Type:%20string) `hostname`> [[uint](#Type:%20uint) `port`]
* `RemoteUplink` "-disconnect" <[string](#Type:%20string) `nameOrIP`>
...
### Members
- [string](#Type:%20string) `Name`
- [string](#Type:%20string) `IPAddress`
- [int](#Type:%20int) `Sessions`
- [session](#Type:%20session) `Session[` [uint](#Type:%20uint) `nthSession` `]`
