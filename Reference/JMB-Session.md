...
# Top-Level Objects
## TLO: JMB
- [joemultiboxer](#type-joemultiboxer) `JMB`
...
- [int](#type-int) `Build`
- [string](#type-string) `Uplink`
- [jmbslot](#type-jmbslot) `Slot`
- [jmbslot](#type-jmbslot) `Slot[` [uint](#type-uint) `numSlot` `]`
- [jsonarray](#type-jsonarray) `Slots`
- [lgui2team](#type-lgui2team) `Team`
- [lgui2team](#type-lgui2team) `Team[` [uint](#type-uint) `id` `]`
- [lgui2team](#type-lgui2team) `Team[` [string](#type-string) `search` `]`
- [jsonarray](#type-jsonarray) `Teams`
- [lgui2character](#type-lgui2character) `Character`
- [lgui2character](#type-lgui2character) `Character[` [uint](#type-uint) `id` `]`
- [lgui2character](#type-lgui2character) `Character[` [string](#type-string) `search` `]`
- [jsonarray](#type-jsonarray) `Characters`
- [uint](#type-uint) `Agent`
- [string](#type-string) `Agent`
- [jsonarray](#type-jsonarray) `Agents`
- [jmbslot](#type-jmbslot) `ForegroundSlot`
- [jmbslot](#type-jmbslot) `MouseOverSlot`
- [jmbslot](#type-jmbslot) `MasterSlot`
- [jmbteam](#type-jmbteam) `AddTeam[` [jsonobject](#type-jsonobject) `json` `]`
- [jmbslot](#type-jmbslot) `AddSlot`
- [jmbcharacter](#type-jmbcharacter) `AddCharacter[` [jsonobject](#type-jsonobject) `json` `]`
- [settingsetref](#type-settingsetref) `GameConfiguration`
- [settingsetref](#type-settingsetref) `InputConfiguration`

### Methods
- `AddCharacter[` [jsonobject](#type-jsonobject) `json` `]`
- `AddTeam[` [jsonobject](#type-jsonobject) `json` `]`
- `AddSlot`
- `ClearSlots`
- `LoadJMBSettings`
- `LoadJMBSettings[` [string](#type-string) `filename` `]`
- `StoreJMBSettings`
- `StoreJMBSettings[` [string](#type-string) `filename` `]`
- `SetMasterSlot[` [uint](#type-uint) `numSlot` `]`
- `ScanAgentsFolder`
- `AddAgent[` [jsonobject](#type-jsonobject) `json` `]`
- `FireAgentEvent[` <"-reverse"> `,` [string](#type-string) `name` `,` [jsonobject](#type-jsonobject) `eventArgs` `]`
- `AddTeamSlots[` [uint](#type-uint) `teamID` `]`
- `RemoveTeamSlots[` [uint](#type-uint) `teamID` `]`
- `RemoveUnusedSlots[`???`]`
...
- [jsonobject](#type-jsonobject) `AsJSON`
- [int64](#type-int64) `ID`
- [unistring](#type-unistring) `DisplayName`
- [unistring](#type-unistring) `ActualName`
- [unistring](#type-unistring) `Server`
- [unistring](#type-unistring) `Game`
- [unistring](#type-unistring) `GameProfile`
- [unistring](#type-unistring) `Path`
- [unistring](#type-unistring) `Executable`
- [unistring](#type-unistring) `Parameters`
- [jsonobject](#type-jsonobject) `Metadata`
- [jmbvirtualfile](#type-jmbvirtualfile) `VirtualFile[` [string](#type-string) `pattern` `]`
- [jsonarray](#type-jsonarray) `VirtualFiles`

### Methods
- `Remove`
- `SetDisplayName[` [string](#type-string) `newValue` `]`
- `SetActualName[` [string](#type-string) `newValue` `]`
- `SetServer[` [string](#type-string) `newValue` `]`
- `SetGame[` [string](#type-string) `newValue` `]`
- `SetGameProfile[` [string](#type-string) `newValue` `]`
- `SetPath[` [string](#type-string) `newValue` `]`
- `SetExecutable[` [string](#type-string) `newValue` `]`
- `SetParameters[` [string](#type-string) `newValue` `]`
- `AddVirtualFile[` <"-exact"> `,` [string](#type-string) `pattern` `,` [string](#type-string) `replacement` `,` <[string](#type-string) `target`="all"> `]`
- `RemoveVirtualFile[` [string](#type-string) `pattern` `]`
- `ClearVirtualFiles`
...
- [jmbvirtualfile](#type-jmbvirtualfile) `VirtualFile[` [string](#type-string) `pattern` `]`
- [jsonarray](#type-jsonarray) `VirtualFiles`
- [int64](#type-int64) `Slot[` [uint](#type-uint) `numSlot` `]`: Retrieves the Character ID for a given Slot number
- [jsonarray](#type-jsonarray) `Slots`
- [jmbcharacter](#type-jmbcharacter) `Character[` [uint](#type-uint) `numSlot` `]`: Retrieves the Character for a given Slot number
- [jsonarray](#type-jsonarray) `Characters`
- [jsonobject](#type-jsonobject) `DefaultSkin`
- [uint](#type-uint) `AddCharacter[` [int64](#type-int64) `characterID` `]`: Adds a Character to the Team, returning its new Slot number
- [uint](#type-uint) `MasterSlot`
- [uint](#type-uint) `DefaultMasterSlot`

### Methods
- `SetDefaultMasterSlot[` [uint](#type-uint) `numSlot` `]`
- `Remove`
- `SetDisplayName[` [string](#type-string) `newValue` `]`
- `AddVirtualFile[` <"-exact"> `,` [string](#type-string) `pattern` `,` [string](#type-string) `replacement` `,` <[string](#type-string) `target`="all"> `]`
- `RemoveVirtualFile[` [string](#type-string) `pattern` `]`
- `ClearVirtualFiles`
- `ClearSlots`
- `AddCharacter[` [int64](#type-int64) `characterID` `]`
- `RemoveCharacter[` [int64](#type-int64) `characterID` `]`
- `RemoveSlot[` [uint](#type-uint) `numSlot` `]`
...
### Members
- [jsonobject](#type-jsonobject) `AsJSON`: JSON representation of the Slot
- [jsonobject](#type-jsonobject) `Metadata[` <[bool](#type-bool) `autoCreate`=false> `]`
- [uint](#type-uint) `ID`
- [uint](#type-uint) `ProcessID`
- [jmbcharacter](#type-jmbcharacter) `Character`: The Character, if any, assigned to the Slot
- [jmbteam](#type-jmbteam) `Team`: The Team, if any, assigned to the Slot
- [uint](#type-uint) `TeamSlot`: The Team Slot (number within the Team) assigned to this Slot
- [bool](#type-bool) `IsMasterSlot`: TRUE if the Slot is currently assigned Team's Master Slot
...
- `SetCharacter[` [uint](#type-uint) `characterID` `]`
- `SetCharacter[` [string](#type-string) `characterName` `]`
- `SetMasterSlot`
...
- [string](#type-string) `Replacement`
- [bool](#type-bool) `ExactMatch`
- [bool](#type-bool) `IsStarted`
- [string](#type-string) `Target`

### Methods
- `SetPattern[` [string](#type-string) `pattern` `,` [bool](#type-bool) `exactMatch`=false `]`
- `SetReplacement[` [string](#type-string) `replacement` `]`
...
### Syntax
* `WindowPosition`
* `WindowPosition` ["-stealth"] ["-viewable"] <[string](#type-string) `XandY`>
...
### Syntax
* `WindowScale`
* `WindowScale` ["-rescale"] <[float](#type-float) `newPercent`>

## Command: Uplink
### Syntax
* `Uplink` <... [string](#type-string) `fullCommand`>

## Command: WindowCharacteristics
### Syntax
* `WindowCharacteristics` ["-stealth"] <... `options` [["-lock"|"-unlock"]|["-restore"]|["-flash"|"-stopflash"]|["-size" ["-viewable"] "fullscreen"]|["-size" ["-viewable"] <[string](#type-string) `widthAndHeight`>]|["-pos" ["-viewable"] <[string](#type-string) `XandY`>]|["-visibility" ["-noactivate"] "foreground"|"alwaysontop"|"down"|"behind"|"bottom"|"minimize"|"restore"]|["-visibility" ["-noactivate"] "behindwindow" <[string](#type-string) `hexHWND`>]|["-frame" "none"|"thick"|"thin"]]>
...
## Command: WindowText
### Syntax
* `WindowText` <... [string](#type-string) `newValue`>
...
### Syntax
* `WindowTaskbar` "off"
* `WindowTaskbar` "on" <... [string](#type-string) `tooltip`>
...
### Syntax
* `FileRedirect` "-list"
* `FileRedirect` "-remove" <[string](#type-string) `originalFilename`>
* `FileRedirect` <[string](#type-string) `originalFilename`> [[string](#type-string) `newFilename`]
...
### Syntax
* `VideoMode` "-list"
* `VideoMode` "-add" <[string](#type-string) `widthAndHeight`>
* `VideoMode` "-emulate" <[string](#type-string) `widthAndHeight`>
...
## TLO: LogReader
- [logreader](#type-logreader) `LogReader`
...
- [videofeedoutput](#type-videofeedoutput) `Output[` [string](#type-string) `name` `]`
- [bool](#type-bool) `PermanentVideoFeeds`
- [jsonarray](#type-jsonarray) `Sources`
- [jsonarray](#type-jsonarray) `Outputs`

### Methods
- `GetSourceIterator[` [weakref](#type-weakref) `iteratorObj` `]`
- `GetOutputIterator[` [weakref](#type-weakref) `iteratorObj` `]`
- `RegisterSource[` [string](#type-string) `name` `,` [string](#type-string) `sessionName` `,` [string](#type-string) `hexHwnd` `]`
- `RegisterSource[` [string](#type-string) `name` `,` [string](#type-string) `sessionName` `,` [string](#type-string) `hexHwnd` `,` [int](#type-int) `left` `,` [int](#type-int) `top` `,` [int](#type-int) `right` `,` [int](#type-int) `bottom` `]`
- `RegisterOutput[` [string](#type-string) `name` `,` [int](#type-int) `left` `,` [int](#type-int) `top` `,` [int](#type-int) `right` `,` [int](#type-int) `bottom` `,` [byte](#type-byte) `alpha` `,` [string](#type-string) `hexRGBBorderColor` `,` [bool](#type-bool) `permanent` `]`
- `SetPermanentVideoFeeds[` [bool](#type-bool) `newValue` `]`
- `UnregisterSource[` [string](#type-string) `name` `]`
- `UnregisterOutput[` [string](#type-string) `name` `]`
...
- [int](#type-int) `Width`
- [int](#type-int) `Height`
- [bool](#type-bool) `ClientAreaOnly`
- [gdiwindow](#type-gdiwindow) `Window`
- [string](#type-string) `Session`
- [string](#type-string) `AsJSON`
...
- [int](#type-int) `Height`
- [int](#type-int) `Alpha`
- [bool](#type-bool) `Border`
- [int](#type-int) `BorderColor`
- [bool](#type-bool) `IsRendering`
- [string](#type-string) `AsJSON`

### Methods
- `SetRect[` [int](#type-int) `left` `,` [int](#type-int) `top` `,` [int](#type-int) `right` `,` [int](#type-int) `bottom` `]`
- `SetAlpha[` [byte](#type-byte) `newValue` `]`
- `SetBorder[` [bool](#type-bool) `expression` `]`
- `SetBorderColor[` [string](#type-string) `hexRGB` `]`
- `Remove`
...
# Top-Level Objects
## TLO: JMBSession
- [jmbsession](#type-jmbsession) `JMBSession`
